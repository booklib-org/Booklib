                    ...
                    <div class="card-body">
                        <table class="table table-responsive-sm table-bordered table-striped table-sm">
                            ...
                            @foreach($results as $file)
                                <tr>
                                    <td><a href="/file/{{$file->id}}">{{$file->title() ?? $file->getFilenameWithoutExtension()}}</a></td>
                                    <td>{{$file->author() ?? ""}} </td>
                                    ...
                                    <td><a href="/file/{{$file->id}}/download"><button class="btn btn-sm btn-success" type="button">Download</button></a></td>
                            @endforeach
                            </tbody>
                        </table>
                        <nav>
